...
namespace CustomControl
{
    ...
    public class TabPagesManager
    {
        ...
        public void AddBtnTab(UIButton btn)
        {
            this._btnList.Add(btn);
        }

        public void SwitchTo(TabPage view)
        {
        ...
        public void SwitchTo(TabPage view, UIButton btnTab)
        {
            foreach (var page in this.pages)
            {
                if (view == page)
            ...
            ToolFunc.BtnSwitchTo(btnTab, _btnList);
        }
    }
